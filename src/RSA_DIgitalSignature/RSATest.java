...
public class RSATest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sign = RSATest.sign(str1.getBytes(), pri_key);/*Sign: An algorithm which takes as input SK and M.Outputs σ. M=s1 in this program*/
        System.out.println("数字签名：\n" + sign);
        boolean vflag1 = das.verify(str1.getBytes(), Base64.decodeBase64(sign), pub_key);/*Verify: Takes input (M, σ, VK). Outputs 0/1*/
